...
bool DateTimeManager::setDateTimeISO(const String& isoDateTime) {
    ...
    int second = isoDateTime.substring(17, 19).toInt();
...
unsigned long DateTimeManager::dateTimeToUnix(int year, int month, int day, 
...
void DateTimeManager::unixToDateTime(unsigned long unixTime, int& year, int& month, int& day,
                                      int& hour, int& minute, int& second) {
