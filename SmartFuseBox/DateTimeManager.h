...
private:
     ...
     */
    static unsigned long dateTimeToUnix(int year, int month, int day, int hour, int minute, int second);
     ...
     */
    static void unixToDateTime(unsigned long unixTime, int& year, int& month, int& day, 
