...
const char FlagMeaning_Q[] PROGMEM = "Quebec – My vessel is healthy\r\nand I request free pratique.";
...
const char FlagMeaning_Y[] PROGMEM = "Yankee – My anchor is dragging.";
...
{
    setPicture(FlagTextName, _currentFlagIndex);
    ...
    if (_currentFlagIndex >= FlagLetterA && _currentFlagIndex <= FlagLetterZ)
    {
        ...
        char buffer[128];
        SystemFunctions::copyString(buffer, meaningPtr, sizeof(buffer));
